...
async function nugetSearch(query, options = {}) {
...
async function nugetPackageVersions(packageId) {
...
export function registerNuGetTools(server) {
            ...
            switch (name) {
                ...
                case 'nuget_list_installed': {
                    ...
                    if (includeTransitive)
                        argsArr.push('--include-transitive');
