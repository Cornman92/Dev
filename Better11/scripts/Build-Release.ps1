...
"@
    ...
    # Uninstall script
    $uninstallScript = @"
# Better11 Uninstallation Script

Write-Host "🗑️  Uninstalling Better11..." -ForegroundColor Cyan

# Remove imported modules
Get-Module -Name "Better11.*" | Remove-Module -Force

Write-Host "✅ Better11 uninstalled successfully" -ForegroundColor Green
"@
    
    $uninstallScript | Out-File -FilePath (Join-Path $releaseDir "Uninstall-Better11.ps1") -Encoding UTF8
