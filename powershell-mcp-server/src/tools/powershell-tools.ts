...
export function registerPowerShellTools(server: Server): void {
        ...
        try {
            switch (name) {
                ...
                case 'ps_invoke_command': {
                    ...
                    const parameters = (a.parameters as Record<string, unknown>) ?? {};
                ...
                case 'ps_get_module': {
                    const modName = a.name as string | undefined;
                ...
                case 'ps_test_analyzer': {
                    ...
                    const excludeRules = a.exclude_rules as string[] | undefined;
